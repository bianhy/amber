...
<title>登录</title>
<link rel="stylesheet" href="<?=STATIC_DOMAIN?>login/css/normalize.css">
<link rel="stylesheet" href="<?=STATIC_DOMAIN?>login/css/login.css">
<link rel="stylesheet" href="<?=STATIC_DOMAIN?>login/css/sign-up-login.css">
<link rel="stylesheet" type="text/css" href="<?=STATIC_DOMAIN?>login/css/font-awesome.min.css">
<link rel="stylesheet" href="<?=STATIC_DOMAIN?>login/css/inputEffect.css" />
<link rel="stylesheet" href="<?=STATIC_DOMAIN?>login/css/tooltips.css" />
<link rel="stylesheet" href="<?=STATIC_DOMAIN?>login/css/spop.min.css" />

<script src="<?=STATIC_DOMAIN?>login/js/jquery-1.10.2.js"></script>
<script src="<?=STATIC_DOMAIN?>login/js/snow.js"></script>
<script src="<?=STATIC_DOMAIN?>login/js/jquery.pure.tooltips.js"></script>
<script src="<?=STATIC_DOMAIN?>login/js/spop.min.js"></script>
<script>
	(function() {
...
body{
    ...
    background-image: url(<?= STATIC_DOMAIN?>login/images/snow.jpg);
